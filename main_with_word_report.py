...
SOURCES = [
    ...
    {"name": "机器之心", "url": "https://www.jiqizhixin.com/rss", "priority": 9},
    {"name": "Hacker News", "url": "https://hnrss.org/frontpage", "priority": 7},
]
...
def send_to_feishu(news_list, word_report_file=None):
    ...
    # 统计数据
    category_stats = Counter([n['source'] for n in news_list])
    ...
    if word_report_file:
        card["elements"].append({
            ...
            "text": {
                "tag": "lark_md",
                "content": f"\n📄 **深度分析报告**: Word 报告已生成，请在 GitHub Actions Artifacts 中下载。"
            }
        })
